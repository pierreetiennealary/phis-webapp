...
<div class="radiometric-target-form well">
    ...
    <div class="alert alert-info" role="alert">
        ...
        <table class="table table-hover" id="radiometric-target-csv-columns-desc">
            <tr>
             ...
             <tr class="dataset-variables">
                <th style="color:red"><?=Yii::t('app', 'Reflectance value (between 0 and 1)') * ?></th>
        ...
        <p><?= Yii::t('app/messages', 'The spectral hemispherical reflectance file uses tabluations (\t) as field separators and dots (.) as decimal separators.') ?> </p>
    </div>
